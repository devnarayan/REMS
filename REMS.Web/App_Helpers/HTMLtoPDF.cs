...
namespace REMS.Web.App_Helpers
{
        ...
        public class HtmlToPdfBuilder
        {
            ...
            #region Constants
            public const string HTML_ATTR_STYLESHEET = "";
            ...
            #endregion
            public string HTMLToPdf(string HTML, string FilePath)
            {
                ...
                try
                {
                    PdfWriter.GetInstance(document, new FileStream(System.Web.HttpContext.Current.Request.PhysicalApplicationPath + "\\PDF\\Receipts\\" + FilePath.ToString() + ".pdf", FileMode.Create));
                }
            ...
            public string DeleteAllFiles(string targetFolder)
            {
