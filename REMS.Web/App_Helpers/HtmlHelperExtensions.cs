...
namespace REMS.Web
{
    public static class HtmlHelperExtensions
    {
        ...
        public static IHtmlString RouteIf(this HtmlHelper helper, string value,string controller,string area, string attribute)
        {
            ...
            var currentArea =
               (helper.ViewContext.RequestContext.RouteData.Values["area"] ?? string.Empty).ToString().UnDash();
